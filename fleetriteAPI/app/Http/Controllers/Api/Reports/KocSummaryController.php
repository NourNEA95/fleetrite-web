...
use App\Services\Reports\KocSummaryReportService;
use App\Traits\HandlesModularReportSessions;
use Illuminate\Http\Request;

class KocSummaryController extends Controller
{
    use HandlesModularReportSessions;

    protected $service;

    public function __construct(KocSummaryReportService $service)
    {
    ...
    {
        return $this->initializeSession($request, 'overspeednew2');
    }
